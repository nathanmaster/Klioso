...
return [
    ...
    */
    ...
    'scanner' => [
        ...
        'automated_scanning' => env('FEATURE_AUTOMATED_SCANNING', false), // Disabled by default
        'security_dashboard' => env('FEATURE_SECURITY_DASHBOARD', true),
    ],

    // Advanced Features (experimental/beta)
    'advanced' => [
        'template_management' => env('FEATURE_TEMPLATE_MANAGEMENT', false),
        ...
        'custom_reports' => env('FEATURE_CUSTOM_REPORTS', false),
    ],
    ...
    // Development/Debug Features (should be false in production)
    'debug' => [
        'debug_toolbar' => env('FEATURE_DEBUG_TOOLBAR', false),
        'query_logging' => env('FEATURE_QUERY_LOGGING', false),
        'test_endpoints' => env('FEATURE_TEST_ENDPOINTS', false),
    ],
];