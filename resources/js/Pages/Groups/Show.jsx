                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className="bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2"
                        >
                        ...
                        <Link
                            ...
                            className="bg-gray-500 hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white px-4 py-2 rounded-lg flex items-center gap-2"
                        ...
                        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Add Websites to Group</h3>
                                    <button
                                        onClick={() => {
                                            setIsAddingWebsites(false);
                                            setSelectedWebsites([]);
                                ...
                                {loading ? (
                                    <div className="text-center py-4 text-gray-600 dark:text-gray-300">Loading ungrouped websites...</div>
                                    ...
                                    <>
                                        <div className="space-y-2 mb-4 max-h-60 overflow-y-auto">
                                            {ungroupedWebsites.map((website) => (
                                                <label key={website.id} className="flex items-center p-3 border dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                                    <input
                                                        type="checkbox"
                    ...
                    {group.websites && group.websites.length > 0 ? (
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {website.wordpress_version && (
                                                <div className="flex justify-between items-center">
                                                    <span className="text-sm text-gray-500 dark:text-gray-400">WordPress:</span>
                                            ...
                                            {website.hosting_provider && (
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <span className="text-sm text-gray-900 dark:text-gray-100">{website.hosting_provider.name}</span>
                                                </div>
                                            )}
                        ...
                        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div className="p-6 text-center">
                                ...
                                <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No websites in this group</h3>
